...
exports.FB_URL   = process.env.FB_URL || 'https://glaring-heat-9657.firebaseio.com';

// The path in your Firebase where clients will write search requests
exports.FB_REQ   = process.env.FB_REQ || 'newsearch/request';

// The path in your Firebase where this app will write the results
exports.FB_RES   = process.env.FB_RES || 'newsearch/response';
